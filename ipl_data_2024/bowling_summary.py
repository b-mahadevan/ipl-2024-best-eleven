...
# Extra Runs
# -----------------------------
extra_runs = df.groupby(['match_id', 'bowling_team', 'bowler'])['extra_runs'].sum().reset_index(name='extra_runs')
...
summary = legal_counts.merge(bowler_runs, on=['match_id', 'bowling_team', 'bowler'], how='left') \
                      ...
                      .merge(extra_runs, on=['match_id', 'bowling_team', 'bowler'], how='left') \
...
summary = summary[['match_id', 'bowling_team', 'bowler', 'overs', 'maidens',
                   ...
                   'extra_runs', 'no_of_wides', 'no_of_no_balls', 'match']]
